...
<div class="pageContent">
    ...
    <table class="table" width="100%" layoutH="138">
        <thead>
            <tr>
                <th width="60">编号</th>
                <th orderField="title" <?php if($_REQUEST["_order"] == 'title'): ?>class="<?php echo ($_REQUEST["_sort"]); ?>"<?php endif; ?>>名称</th>
                <th>简介</th>
                <th width="100">操作</th>
        </tr>
        </thead>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr target="sid_node" rel="<?php echo ($vo['id']); ?>">
                ...
                <td><a href="__APP__/Class/id/<?php echo ($vo['id']); ?>/" target="navTab" rel="__MODULE__"><?php echo ($vo['name']); ?></a></td>
                <td><?php echo ($vo['info']); ?></td>
                <td><a href="__URL__/edit/id/<?php echo ($vo['id']); ?>" target="navTab">编辑</a></td>
